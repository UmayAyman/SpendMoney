...
function Product({ totalMoney, setTotalMoney }) {
    ...
    { id: 6, name: "Lobester Dinner", price: 45, image: "https://neal.fun/spend/images/lobster-dinner.jpg" ,quantity: 0},
    ...
    { id: 10, name: "AirJordans", price: 125, image: "https://neal.fun/spend/images/air-jordans.jpg" ,quantity: 0},
    ...
    { id: 23, name: "Luxury Vine", price: 70000, image: "https://neal.fun/spend/images/luxury-wine.jpg" , quantity: 0},
    ...
    { id: 31, name: "Single Family House", price: 3000000, image: "https://neal.fun/spend/images/single-family-home.jpg" ,quantity: 0},
    { id: 32, name: "Gold Bar", price: 7000000, image: "https://neal.fun/spend/images/gold-bar.jpg" ,quantity: 0},
    ...
    { id: 38, name: "Helicopter", price: 31000000, image: "https://neal.fun/spend/images/apache-helicopter.jpg",quantity: 0 },
...
return (
    ...
    <div className="product-grid">
        ...
        <div key={product.id} className="product-card">
            ...
            onChange={(newQuantity) => updateProductQuantity(product.id, newQuantity)}
            price={product.price}
